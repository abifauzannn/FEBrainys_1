...
<div id="buttonText" class="text-center text-white text-base font-semibold font-['Inter'] leading-normal">Login</div>
</button>
...
<button type="submit"
    ...
    <a href="{{ url('/login/google') }}" class="text-black text-opacity-50 text-base font-medium font-['Roboto']">Sign
        in with Google</a>
</button>
