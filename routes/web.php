...
Route::get('/order/detail/{transaction_code}', [SubscriptionController::class, 'showDetailOrder'])->name('order.detail');
Route::get('/payment/stream/{transaction_code}', [SubscriptionController::class, 'stream'])->name('payment.stream');
