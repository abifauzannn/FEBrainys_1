            ...
            <ul class="flex flex-wrap -mb-px">
                <li class="me-2">
                    <a href="{{ route('langganan.tagihan') }}"
                        class="inline-block p-4 border-b-2 rounded-t-lg {{ request()->routeIs('langganan.tagihan') ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent' }} hover:text-gray-600 hover:border-gray-300  ">
                        Tagihan
                    </a>
                </li>
                <li class="me-2">
                    <a href="{{ route('langganan.pilih-paket') }}"
                        class="inline-block p-4 border-b-2 rounded-t-lg {{ request()->routeIs('langganan.pilih-paket') ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent' }} hover:text-gray-600 hover:border-gray-300  ">
                        Pilih Paket
                    </a>
                </li>
                <li class="me-2">
                    <a href="{{ route('langganan.beli-credit') }}"
                        class="inline-block p-4 border-b-2 rounded-t-lg {{ request()->routeIs('langganan.beli-credit') ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent' }} hover:text-gray-600 hover:border-gray-300  ">
                        Beli Credit
                    </a>
                </li>
            </ul>
