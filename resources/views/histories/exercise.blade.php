...
@section('title', 'History Exercise - Brainys')
...
@section('content')
    ...
    <div class="container mx-auto px-4 sm:px-10 py-9 font-['Inter']">
        ...
        <a href="{{ route('essay') }}" class="block mb-6">
        ...
        <div class="container mx-auto py-3">
            <div class="text-2xl md:text-[32px] font-bold font-inter leading-[49.99px]">Recent History Generate Exercise
            </div>
